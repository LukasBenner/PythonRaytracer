...
class Camera:
    ...
    def calculateRayDirection(self, x, y) -> np.ndarray((3,1)):

        offsetX = Utils.randomDouble() * 2.0 - 1.0
        offsetY = Utils.randomDouble() * 2.0 - 1.0
        ...
        return np.array([rayDirection[0], rayDirection[1], rayDirection[2]])